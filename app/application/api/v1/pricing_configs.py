...
async def create_pricing_config(
    request: PricingConfigCreate, pricing_config_service: pricing_config_service_deps
...
async def get_pricing_config(
    reo_id: int, pricing_config_service: pricing_config_service_deps
) -> PricingConfigResponse:
...
async def get_all_pricing_configs(pricing_config_service: pricing_config_service_deps) -> list[PricingConfigResponse]:
...
async def delete_pricing_config(id: int, pricing_config_service: pricing_config_service_deps) -> None:
