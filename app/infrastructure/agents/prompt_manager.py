class PromptManager:
    ...
    5. Важливо:
       ...
       8) Виводь РІВНО у форматі масиву JSON:
        – `name`: ім'я зображення (наприклад `"flat1.png"`)
        – `values`: масив з одним елементом — ім'ям зображення, наприклад `["flat1.png"]`
    ...
    {
      "floor": [
        {"name": "<ім'я зображення>", "values": ["<ім'ям зображення>"], "priority": <ранг>},
        {"name": "<ім'я зображення>", "values": ["<ім'ям зображення>"], "priority": <ранг>},
        {...}
      ]
    }
