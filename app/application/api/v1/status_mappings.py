...
async def create_status_mapping(
    request: StatusMappingCreate, status_mapping_service: status_mapping_service_deps
...
async def get_status_mapping(id: int, status_mapping_service: status_mapping_service_deps) -> StatusMappingResponse:
    status_mapping = await status_mapping_service.get(id=id)
    return status_mapping


@router.get("/", response_model=list[StatusMappingResponse])
async def get_all_status_mappings(status_mapping_service: status_mapping_service_deps) -> list[StatusMappingResponse]:
...
async def delete_status_mapping(id: int, status_mapping_service: status_mapping_service_deps) -> None:
