from app.application.api.depends import current_user_deps, status_mapping_service_deps
...
async def create_status_mapping(
    request: StatusMappingCreate, status_mapping_service: status_mapping_service_deps, _: current_user_deps
...
async def get_status_mapping(
    id: int, status_mapping_service: status_mapping_service_deps, _: current_user_deps
) -> StatusMappingResponse:
...
async def get_all_status_mappings(
    status_mapping_service: status_mapping_service_deps, _: current_user_deps
) -> list[StatusMappingResponse]:
...
async def update_status_mapping(
    id: int, request: StatusMappingUpdate, status_mapping_service: status_mapping_service_deps, _: current_user_deps
) -> StatusMappingResponse:
