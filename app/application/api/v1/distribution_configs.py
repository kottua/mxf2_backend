...
async def create_distribution_config(
    request: DistributionConfigCreate, distribution_config_service: distribution_config_service_deps
) -> DistributionConfigResponse:
...
async def get_distribution_config(
    id: int, distribution_config_service: distribution_config_service_deps
) -> DistributionConfigResponse:
...
async def update_distribution_config(
    id: int, request: DistributionConfigUpdate, distribution_config_service: distribution_config_service_deps
) -> DistributionConfigResponse:
...
async def delete_distribution_config(id: int, distribution_config_service: distribution_config_service_deps) -> None:
